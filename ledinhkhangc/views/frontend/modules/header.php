                ...
                <div class="row">
                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        ...
                                        <li class="last">
                                            <a href="#"><img src="<?=URL; ?>public/images/search_icon.png" alt="icon" /></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <div class="col-md-6 offset-md-6">
                        <div class="location_icon_bottum">
                            <ul>
                                <li><img src="<?=URL; ?>public/images/call.png" />(+71)9876543109</li>
                                <li><img src="<?=URL; ?>public/images/email.png" />demo@gmail.com</li>
                                <li><img src="<?=URL; ?>public/images/loc.png" />Location</li>
                            </ul>
                        </div>
                    </div>
                </div>
